(function () {
  ...
  function injectStyles() {
    if (document.getElementById("popup-lander-styles")) return;
    ...
    style.textContent = `
      ...
      .cookie-accept {
        ...
        background: #73cf52;
        color: #071207;
        box-shadow: 0 8px 22px rgba(90, 190, 65, 0.22);
      }
  ...
  function createPopup(mode) {
    ...
    overlay.innerHTML = `
      <div class="cookie-modal">
        ...
        <p class="cookie-copy">
          ...
          By clicking <strong>Accept All</strong> you agree to
          our use of cookies.
        </p>
    ...
    const accept =
      overlay.querySelector(".cookie-accept");

    const reject =
      overlay.querySelector(".cookie-reject");
     ...
     * Reject → index.html
     *
     * Popup does NOT close on its own.
     */
    if (mode === "lander") {
   ...
   * Public function
   */
  window.PopupLander = function (mode) {

    createPopup(mode || "index");
